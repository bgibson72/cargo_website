    ...
    >
      ...
      >
        ...
        >
          {/* iOS App Store */}
          <a
            href="https://apps.apple.com/app/cargo/id6760857857"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-base font-medium transition-all hover:scale-105 active:scale-95"
        ...
        <p className="text-sm" style={{ color: "var(--text-muted)" }}>
          Now available on iPhone · iPad &nbsp;·&nbsp; Mac coming soon
        </p>
      </motion.div>
